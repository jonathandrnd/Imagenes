	...
	for (int i = 0;; ++i)
	{
		...
		*/
		...
		if (found)                // If done with success, 
		{
			...
			/* Esta parte solo me sirve para comparar los puntos de los centros del padron con lo que bota mi propio algoritmo
	...
	double totalAvgErr)
{
	...
	myfile << "board_Width" << s.boardSize.width << endl;
	myfile << "board_Height" << s.boardSize.height << endl;
	myfile << "square_Size" << s.squareSize << endl;


	if (s.flag & CV_CALIB_FIX_ASPECT_RATIO)
		myfile << "FixAspectRatio" << s.aspectRatio;

	myfile << "flagValue" << s.flag;
